...
contract TheFunixCryptoSim is ERC721, Ownable  {
    ...
    // *** START Code here***
    function nameOfToken() public pure returns(string memory) {
        return "TheFunixCryptoSims";
    }

    function symbolOfToken() public pure returns(string memory) {
        return "FCS";
    }
        ...
        returns (SimAttributes memory)
    {
        ...
        // TASK #4: Calculate remaining attributes
        // START CODE HERE
        if (x==0) {
